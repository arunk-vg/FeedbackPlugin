...
@WebSudoRequired
public class FeedbackReportAction extends JiraWebActionSupport
{
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(FeedbackReportAction.class);
/*   
    ...
    public FeedbackReportAction(final PermissionManager permissionManager, final JiraAuthenticationContext authenticationContext)
    {
